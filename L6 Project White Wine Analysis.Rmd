...
ggplot(aes(x = quality), data = w_w) +      
  geom_bar(color = 'black', fill = 'grey25') +
...
ggplot(data = w_w, aes(x = residual.sugar)) +
  geom_histogram(binwidth = 0.5, fill = "grey25") +
...
ggplot(aes(x = residual.sugar), data = w_w) +
  geom_histogram(binwidth = 0.5, color = 'black', fill = "grey25") +
...
ggplot(aes(x = sulphates), data = w_w) +
  geom_histogram(binwidth = 0.02, color = 'black', fill = 'grey25') + 
...
ggplot(aes(x = pH), data = w_w) +
  geom_histogram(binwidth = 0.05, color = 'black', fill = 'grey25') +
  theme(axis.title = element_text(size = 10, face = "bold"))
```
...
ggplot(aes(x = alcohol), data = w_w) + 
  geom_histogram(binwidth = 0.01, color = 'black', fill = 'grey25') + 
  scale_x_sqrt() +
...
ggplot(aes(x = density), data = w_w) +
  geom_histogram(binwidth = 0.0002, color = 'black', fill = 'grey25') + 
...
ggplot(aes(x = fixed.acidity), data = w_w) +
  geom_histogram(binwidth = 0.25, color = 'black', fill = 'grey25') + 
...
ggplot(aes(x = total.sulfur.dioxide), data = w_w) +
  geom_histogram(binwidth = 10, color = 'black', fill = 'grey25') + 
...
ggplot(aes(x = free.sulfur.dioxide), data = w_w) +
  geom_histogram(binwidth = 1.0, color = 'black', fill = 'grey25')+ 
...
```{r echo=FALSE, fig.height=20, fig.width=20, message=FALSE, warning=FALSE, Bivariate_Plots}
#Scatterplot matrix
...
w_w_matrix <- ggpairs(w_w_subset_matrix[sample.int(nrow(w_w_subset_matrix), 150), ], columns = 
          c("fixed.acidity", "volatile.acidity", "citric.acid", 
            "residual.sugar", "chlorides", "free.sulfur.dioxide", 
            "total.sulfur.dioxide", "density", "pH", "sulphates", "alcohol", 
            "quality"), columnLabels = c("fixed acidity", "volatile acidity", 
...
ggscatmat(subset(w_w, select = -c(X))) +theme_grey(base_size=5)
```
...
ggplot(data = w_w, aes(x = citric.acid, y = residual.sugar)) +
   geom_line(stat = 'summary', fun.y = median, aes(color = factor(quality))) +
